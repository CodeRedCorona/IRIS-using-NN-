...
The IRIS dataset has five columns: Sepal-Length, Sepal-Width, Petal-Length, Petal-Width, and specie.
It has 150 entries (rows).

Sepal-Length, Sepal-Width, Petal-Length, and Petal-Width are numerical in nature.
while, Specie is categorical. A particular flower can be any one of these three species: Iris-setosa, Iris-versicolor, Iris-virginica.
